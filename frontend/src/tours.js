...
export const MAIN_TOUR = [
  ...
  },
  {
    ...
    placement: 'right',
    sidebar: true,
    title: 'Spaces hold your projects',
    body: 'A space is a big bucket — Work, Studies, Side hustle. Press + to create one, then add projects inside it. Tasks live inside projects.',
    points: [
      { icon: '＋', text: 'New space — the + next to "Spaces"' },
      { icon: '▸', text: 'Click a space to expand its projects' },
      { icon: '⠿', text: 'Drag the handle to reorder; right-click for edit, share and delete' },
    ],
  },
  {
    id: 'shared',
  ...
  },
  {
    ...
    body: 'Spaces, tasks done, tasks total and overall completion — recalculated as you tick things off.',
  },
  {
    id: 'focus',
    ...
    placement: 'bottom',
    title: "Today's Focus",
    body: 'The handful of tasks that actually need you today, ranked by deadline and priority. Tick one off right from the card, or click it to jump to its project.',
  },
  {
    id: 'space-cards',
    ...
    body: 'Each card fills up like a glass as its tasks get completed. Click one to open it and see the projects inside.',
  },
  {
    id: 'topbar',
  ...
  },
  {
    ...
    body: 'Create a space to get going. The first time you open a project, I will point out the task tools in there as well.',
  },
];
...
export const PROJECT_TOUR = [
  {
    ...
    body: 'The banner carries the project colour and its completion percentage — the wave behind it rises as tasks get done.',
  },
  {
    id: 'collab',
    ...
    body: 'Add people by email or username, as an editor (can change things) or a viewer (read only). Their avatars stack up here.',
  },
  {
    id: 'call',
  ...
  },
  {
    ...
    points: [
      ...
      { icon: '▤', text: 'Board — drag tasks between To do / Doing / Done' },
  ...
  },
  {
    ...
    placement: 'top',
    title: 'Add a task',
    body: 'Type and hit Enter. Open a task afterwards to give it a deadline, priority, assignee, labels, notes or file attachments.',
  ...
  },
  {
    ...
    placement: 'top',
    title: 'Project notes',
    body: 'A scratchpad that saves as you type — strategy, links, references. The ⤢ button opens it in the full rich editor.',
  },
  {
    id: 'files',
  ...
  },
  {
    ...
    body: 'Replay either tour any time from Profile → Preferences → App guide.',
  },
];
...
// Defaults to "seen" when storage is unavailable — better to skip the tour
// than to replay it on every single load.
